...
REGISTRY: dict[str, OAuthProvider] = {
    ...
    for p in (
        ...
        # API-key providers
        APOLLO, PDL, AKTA, HUNTER, SUMBLE, MOLTSETS, HARVESTAPI, DROPLEADS, QUICKENRICH, PROSPEO, WIZA, GETLEADSIO, SCRUBBY, ZEROBOUNCE, TRYKITT, CONTACTOUT, MILLIONVERIFIER, BOUNCEBAN, CRUNCHBASE, MINIMAX, OPENROUTER, REPLICATE,
        REAPI, PIAPI,
