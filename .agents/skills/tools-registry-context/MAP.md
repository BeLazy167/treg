...
| `src/treg/catalog/examples/tavily.web.crawl.json` | architecture/catalog.md |
| `src/treg/catalog/examples/tavily.web.extract.json` | architecture/catalog.md |
| `src/treg/catalog/examples/tavily.web.map.json` | architecture/catalog.md |
| `src/treg/catalog/examples/tavily.web.search.json` | architecture/catalog.md |
| `src/treg/catalog/examples/tomba.people.email.verify.json` | architecture/catalog.md |
| `src/treg/catalog/examples/trestleiq.people.address.verify.json` | architecture/catalog.md |
| `src/treg/catalog/examples/trestleiq.people.contact.verify.json` | architecture/catalog.md |
| `src/treg/catalog/examples/trestleiq.people.phone.verify.json` | architecture/catalog.md |
