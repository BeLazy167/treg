...
def test_every_provider_is_registered():
    assert set(P.REGISTRY) == {
        ...
        "apollo", "pdl", "akta", "hunter", "sumble", "harvestapi", "dropleads", "quickenrich", "prospeo", "wiza", "getleadsio", "contactout", "millionverifier", "bounceban", "trykitt", "crunchbase", "tikhub", "brightdata", "semrush", "justoneapi",
        "scrapecreators",
