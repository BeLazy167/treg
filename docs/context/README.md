...
| [Endpoint catalog — what you can DO with a connected key, and which provider should do it](architecture/catalog.md) | shipped | fishaudio.yaml, fishaudio.tts.s2-1-pro.json, fishaudio.voices.create.json, provider_resources.py, … |
