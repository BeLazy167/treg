...
| [ZeroBounce — single email validation and account capacity](architecture/zerobounce.md) | implemented; live authentication and response shapes verified | zerobounce.yaml, zerobounce.people.email.verify.json, zerobounce.account.credits.json, zerobounce.account.usage.json, … |
